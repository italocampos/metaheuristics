...
def model_33bus():
	...
	line1 = pp.create_line(net, from_bus=bus0, to_bus=bus1, length_km=0.1, std_type='line1', name='line1')
	line2 = pp.create_line(net, from_bus=bus1, to_bus=bus2, length_km=0.1, std_type='line2', name='line2')
	line3 = pp.create_line(net, from_bus=bus2, to_bus=bus3, length_km=0.1, std_type='line3', name='line3')
	line4 = pp.create_line(net, from_bus=bus3, to_bus=bus4, length_km=0.1, std_type='line4', name='line4')
	line5 = pp.create_line(net, from_bus=bus4, to_bus=bus5, length_km=0.1, std_type='line5', name='line5')
	line6 = pp.create_line(net, from_bus=bus5, to_bus=bus6, length_km=0.1, std_type='line6', name='line6')
	line7 = pp.create_line(net, from_bus=bus6, to_bus=bus7, length_km=0.1, std_type='line7', name='line7')
	line8 = pp.create_line(net, from_bus=bus7, to_bus=bus8, length_km=0.1, std_type='line8', name='line8')
	line9 = pp.create_line(net, from_bus=bus8, to_bus=bus9, length_km=0.1, std_type='line9', name='line9')
	line10 = pp.create_line(net, from_bus=bus9, to_bus=bus10, length_km=0.1, std_type='line10', name='line10')
	line11 = pp.create_line(net, from_bus=bus10, to_bus=bus11, length_km=0.1, std_type='line11', name='line11')
	line12 = pp.create_line(net, from_bus=bus11, to_bus=bus12, length_km=0.1, std_type='line12', name='line12')
	line13 = pp.create_line(net, from_bus=bus12, to_bus=bus13, length_km=0.1, std_type='line13', name='line13')
	line14 = pp.create_line(net, from_bus=bus13, to_bus=bus14, length_km=0.1, std_type='line14', name='line14')
	line15 = pp.create_line(net, from_bus=bus14, to_bus=bus15, length_km=0.1, std_type='line15', name='line15')
	line16 = pp.create_line(net, from_bus=bus15, to_bus=bus16, length_km=0.1, std_type='line16', name='line16')
	line17 = pp.create_line(net, from_bus=bus16, to_bus=bus17, length_km=0.1, std_type='line17', name='line17')
	line18 = pp.create_line(net, from_bus=bus1, to_bus=bus18, length_km=0.1, std_type='line18', name='line18')
	line19 = pp.create_line(net, from_bus=bus18, to_bus=bus19, length_km=0.1, std_type='line19', name='line19')
	line20 = pp.create_line(net, from_bus=bus19, to_bus=bus20, length_km=0.1, std_type='line20', name='line20')
	line21 = pp.create_line(net, from_bus=bus20, to_bus=bus21, length_km=0.1, std_type='line21', name='line21')
	line22 = pp.create_line(net, from_bus=bus2, to_bus=bus22, length_km=0.1, std_type='line22', name='line22')
	line23 = pp.create_line(net, from_bus=bus22, to_bus=bus23, length_km=0.1, std_type='line23', name='line23')
	line24 = pp.create_line(net, from_bus=bus23, to_bus=bus24, length_km=0.1, std_type='line24', name='line24')
	line25 = pp.create_line(net, from_bus=bus5, to_bus=bus25, length_km=0.1, std_type='line25', name='line25')
	line26 = pp.create_line(net, from_bus=bus25, to_bus=bus26, length_km=0.1, std_type='line26', name='line26')
	line27 = pp.create_line(net, from_bus=bus26, to_bus=bus27, length_km=0.1, std_type='line27', name='line27')
	line28 = pp.create_line(net, from_bus=bus27, to_bus=bus28, length_km=0.1, std_type='line28', name='line28')
	line29 = pp.create_line(net, from_bus=bus28, to_bus=bus29, length_km=0.1, std_type='line29', name='line29')
	line30 = pp.create_line(net, from_bus=bus29, to_bus=bus30, length_km=0.1, std_type='line30', name='line30')
	line31 = pp.create_line(net, from_bus=bus30, to_bus=bus31, length_km=0.1, std_type='line31', name='line31')
	line32 = pp.create_line(net, from_bus=bus31, to_bus=bus32, length_km=0.1, std_type='line32', name='line32')
	line33 = pp.create_line(net, from_bus=bus7, to_bus=bus20, length_km=0.1, std_type='line33', name='line33')
	line34 = pp.create_line(net, from_bus=bus8, to_bus=bus14, length_km=0.1, std_type='line34', name='line34')
	line35 = pp.create_line(net, from_bus=bus11, to_bus=bus21, length_km=0.1, std_type='line35', name='line35')
	line36 = pp.create_line(net, from_bus=bus17, to_bus=bus32, length_km=0.1, std_type='line36', name='line36')
	line37 = pp.create_line(net, from_bus=bus24, to_bus=bus28, length_km=0.1, std_type='line37', name='line37')
